...
- [ ] Source and generation provenance is sufficient to identify the Approved Techplan/revision and, when exposed/safe to persist, the generating agent/model/session.

```markdown
# Report: {Story/Task Title}

> Phase             : Techplan approved report
...
> Source            : {path to approved techplan.md + source revision/commit when known}
...
---
*Full execution detail, rule IDs, implementation anchors, verification ownership/rationale, and complete risk/decision history: see the Approved source Techplan.*
```
