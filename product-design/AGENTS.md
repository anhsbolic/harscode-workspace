# AGENTS.md — product-design/

Read `README.md` first. This file is the short routing and governance layer for upstream product-design guidance.
...
- Changes to shared `product-design/` guidance require a root `proposals/` entry and human review.
