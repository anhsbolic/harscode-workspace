...
| react | [react/testing-automation-boundary.md](react/testing-automation-boundary.md) | eslint rule, lint enforcement, automation, manual review, no-restricted-syntax, jest-axe | no | Grep/AST-pattern-matchable checklist items become lint rules, not prose reminders; intent/judgment items stay manual at the existing human-checkpoint/Finalize stage |
