...
| client-security | pwa/xss-and-content-sanitization.md, pwa/token-storage-and-refresh.md |
...
**Coverage complete for initial pass** across go/, postgresql/, graphql/, restapi/, kafka/, pubsub/, redis/, infra/, pwa/. Add rows above as new files land, or as new categories are introduced.
